...
_RE_EXPORTS = {
    ...
    "deepseek_reasoning_effort": ("src.llm", "deepseek_reasoning_effort"),
    "deepseek_thinking_type": ("src.llm", "deepseek_thinking_type"),
    ...
    "is_deepseek_request": ("src.llm", "is_deepseek_request"),
    ...
    "usd_cny_rate": ("src.llm", "usd_cny_rate"),
